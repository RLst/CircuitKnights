...
namespace CircuitKnights
{
    ...
    public class RightArmHealth : Damageable
    {
        ...
        public static event Action<Player.Number, float> OnRightArmHit = delegate { };
        public static event Action<Player.Number> OnRightArmDeath = delegate { };      //Subject or broadcaster; And observer needs to implement this
        ...
        void OnCollisionEnter(Collision other)
        {
            if (other.collider == opponent.LanceCollider)
            {
                ...
                if (!isInvincible)
                {
                    ...
                    OnRightArmHit(player.No, attackMultiplier);
