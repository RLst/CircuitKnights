...
// {
//     public class xPlayerIKLeanDodge : MonoBehaviour
//     {
// 		[Multiline]
...
// 			newSpinePosition.z += playerInput.LeanLeft * dodgeFactor * Time.deltaTime;
// 			spine.position += newSpinePosition;
// 			spine.rotation *= Quaternion.Euler(0f, playerInput.LeanLeft * leanFactor * Time.deltaTime, 0f);
// 		}
//     }
// }